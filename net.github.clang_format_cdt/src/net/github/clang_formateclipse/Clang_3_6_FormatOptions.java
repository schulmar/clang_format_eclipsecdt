...
public class Clang_3_6_FormatOptions extends ClangVersionOptions {

	public Clang_3_6_FormatOptions() {
	}
	...
	FormatOption[] getFormatOptions() {
		return new FormatOption[] {
				...
				/*
				 * TODO: removed from 3.5? new BooleanFormatOption(
